...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: '邮箱',
      method: 'HEAD',
      target: 'https://mail.afingpo.top/',
      statusPageLink: 'https://mail.afingpo.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '博客',
      method: 'HEAD',
      target: 'https://afingpo.top/',
      statusPageLink: 'https://afingpo.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
  ...
  notification: {
    ...
    webhook: {
      ...
      payload: {
        "from": "系统状态更新 <uptimeflare@465332.xyz>",
        "to": ["afipo_han@outlook.com"],
